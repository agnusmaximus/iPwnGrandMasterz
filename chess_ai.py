...
def get_move_pts(mv):
    ...
    pt1 = (w1 * chess_screen_capture.piece_dim + chess_screen_capture.left_x + chess_screen_capture.piece_dim/2,
           h1 * chess_screen_capture.piece_dim + chess_screen_capture.left_y + chess_screen_capture.piece_dim/2)
    pt2 = (w2 * chess_screen_capture.piece_dim + chess_screen_capture.left_x + chess_screen_capture.piece_dim/2, 
           h2 * chess_screen_capture.piece_dim + chess_screen_capture.left_y + chess_screen_capture.piece_dim/2)
